...
export async function sync(params = {}) {
  ...
  // 2–3. Load one active Shopee connection
  ...
  // 5. Call Shopee Open API v2 shop info (auth proof of concept)
  ...
  // 6. Return proof-of-concept response (no DB write)
  return {
    success: true,
    marketplace: 'shopee',
    shop_id,
